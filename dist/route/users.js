...
userRouter.post('/register', _authenticate["default"], _validation.userValidation, _user["default"].addUser).post('/login', _validation.userLoginValidation, _user["default"].login).put('/:id/edit', _authenticate["default"], _validation.editValidation, _user["default"].editUser)["delete"]('/:id/abolish', _authenticate["default"], _user["default"].deleteUser).get('/all', _authenticate["default"], _user["default"].usersList);
